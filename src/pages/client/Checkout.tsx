    ...
    return (
        <main className="w-4/5 mx-auto bg-slate-50 rounded-lg  flex">
            <div className="order-info w-1/2 border-r p-8 rounded-lg">
                <h2 className='text-center font-semibold text-2xl pb-8'>Thông tin vận chuyển</h2>
                <Form
                    name="basic"
                    wrapperCol={{ span: 16 }}
                    style={{ maxWidth: 600 }}
                ...
                >
                    ...
                    <Form.Item
                        ...
                        rules={[{ required: true, message: 'Please input your shippingAddress!' }]}
                    >
                        <Input />
                    </Form.Item>
                    <Form.Item
                    ...
                    <Form.Item wrapperCol={{ offset: 8, span: 16 }}>
                        <Button className='w-5/12' danger type="primary" htmlType="submit">
                            Thanh toán
                        </Button>
                    </Form.Item>
                </Form>
